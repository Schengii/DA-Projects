...
// funktion to rezept load on landing page
 ...
 function rezeptLoadKaiserschmarrn(){
  ...
  return document.getElementById('rezept_load_section').innerHTML = '<div class="view_width df jcc"><div class="max-width "><div class="rezept_des_tages_section margin_top_und_bottom_100 "><div class="rezept_des_tages_section_bild margin_left"><img class="vorschaubild" src="./img/kaiserschmarrn.jpg" alt="vorschaubild"></div><div class="rezept_des_tages_sections  margin_right"><h2 class="marginBottom_textH2">Kaiserschmarrn</h2><span class="rezept_des_tages_section_span">Kaiserschmarrn ist ein traditionelles österreichisches Rezept: ein flaumiger, zerrissener Pfannkuchen, serviert mit Puderzucker, Kompott und manchmal Rosinen. Perfekt als süßes Hauptgericht oder Dessert.</span><div class="fullHeightBetweenTextAndButton"></div><label for="rezept_oefnen"></label><a href="./kaiserschmarrn.html"> <button type="button" class="marginBottom_textH2  button_rezept_open rezept_des_tages_section_text_button">Rezept öffnen </button></a> </div> </div> </div> </div>';
...
function rezeptLoadSchnitzel(){
    document.getElementById('rezept_load_section').innerHTML = "";
  return document.getElementById('rezept_load_section').innerHTML = '<div class="view_width df jcc">        <div class="max-width ">            <div class="rezept_des_tages_section margin_top_und_bottom_100 ">                <div class="rezept_des_tages_section_bild margin_left">                    <img class="vorschaubild" src="./img/schniposa.webp" alt="vorschaubild">                </div>                <div class="rezept_des_tages_sections  margin_right">                    <h2 class="marginBottom_textH2">Schnitzel mit Pommes</h2>                    <span class="rezept_des_tages_section_span">Schnitzel mit Pommes? Wer liebt dieses Essen nicht schon von Kindesbeinen an? Das knusprige Schnitzel in selbstgemachter Panade zusammen mit leckeren Pommes machen diesen Klassiker aus. Es geht schnell und einfach und fast jeder mag es, den Salat kann man nach belieben auch weglassen.</span>                        <div class="fullHeightBetweenTextAndButton"></div>                    <label for="rezept_oefnen"></label>                    <a href="./schnitzel.html"> <button type="button"                            class="marginBottom_textH2  button_rezept_open  rezept_des_tages_section_text_button">Rezept                            öffnen                        </button></a>                </div>            </div>        </div>    </div>';

}

function rezeptLoadSpaghetti(){
    document.getElementById('rezept_load_section').innerHTML = "";
  return document.getElementById('rezept_load_section').innerHTML = '<div class="view_width df jcc">        <div class="max-width ">            <div class="rezept_des_tages_section margin_top_und_bottom_100 ">                <div class="rezept_des_tages_section_bild margin_left">                    <img class="vorschaubild" src="./img/spaghetti.jpg" alt="vorschaubild">                </div>                <div class="rezept_des_tages_sections  margin_right">                    <h2 class="marginBottom_textH2">Spaghetti mit Tomaten-Parmesansoße</h2>                    <span class="rezept_des_tages_section_span">Spaghetti mit Tomaten-Parmesansoße ist ein einfaches und klassisches italienisches Gericht. Die Basis besteht aus Spaghetti, die mit einer aromatischen Tomatensauce serviert werden. Es ist ein leichtes, aber dennoch sehr schmackhaftes Gericht, das sowohl in Italien als auch weltweit sehr beliebt ist.</span>                        <div class="fullHeightBetweenTextAndButton"></div>                    <label for="rezept_oefnen"></label>                    <a href="./spaghetti.html"> <button type="button"                            class="marginBottom_textH2  button_rezept_open  rezept_des_tages_section_text_button">Rezept                            öffnen                        </button></a>                </div>            </div>        </div>    </div>';

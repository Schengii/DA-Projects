...
// verschiedene Möglichkeiten in der Konsole
...
document.getElementById('test_input').setAttribute('value', 'dshfksdjhflk');
document.getElementById('test_input').setAttribute('value', 123);
document.getElementById('test_input').value = 12342;
